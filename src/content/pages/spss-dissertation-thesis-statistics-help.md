...
priority: "high"
contextualBorderQuestion: "Which chapter are you working on: the analysis plan, the results, or the discussion?"
bridgesTo:
...
The rule that catches the most students: **every statistic you report needs its full APA sentence** (e.g. *t*(48) = 2.31, *p* = .025, *d* = 0.66), not just "the result was significant." See the full [Chapter 4 results guide](/dissertation-chapter-4-results-help/) for worked examples across every test type and the table-formatting rules.
...
Whichever chapter or degree stage you're at, see the full [SPSS statistical test guide](/spss-statistical-tests-explained/) to confirm which test your research question actually calls for before you run anything.
