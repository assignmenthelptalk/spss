...
bridgesTo:
  ...
  - "power-analysis-sample-size-assignment-help"
publishOrder: 51
draft: false
---
...
- The specific test that matches that combination (see the [SPSS statistical test guide](/spss-statistical-tests-explained/) for the full decision logic)
