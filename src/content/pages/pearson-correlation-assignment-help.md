...
If your data is ordinal, or badly violates the normality/outlier assumptions above, use Spearman's rank correlation instead — see the full [SPSS statistical test guide](/spss-statistical-tests-explained/). If your assignment asks you to *predict* one variable from another rather than just describe their relationship, you need [simple linear regression](/simple-linear-regression-assignment-help/), which builds directly on everything above.
